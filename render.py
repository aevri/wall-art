...
def main():
    ...
    height = 800
    mid_y = height // 2
    canvas = np.ones((height, width, 4))  # RGBA

    x = np.linspace(0, 1, width).reshape(1, width, 1)
    y = np.linspace(0, 1, height).reshape(height, 1, 1)

    eucalyptus_green = np.array([[0.392, 0.706, 0.588, 1]])
    eucalyptus_green2 = np.array([[0.412, 0.706, 0.588, 1]])
    eucalyptus_green3 = np.array([[0.372, 0.706, 0.588, 1]])
    eucalyptus_green4 = np.array([[0.392, 0.726, 0.588, 1]])
    eucalyptus_green5 = np.array([[0.392, 0.706, 0.608, 1]])
    eucalyptus_green6 = np.array([[0.392, 0.686, 0.588, 1]])

    sage_green = np.array([[0.557, 0.663, 0.557, 1]])
    racing_green = np.array([[0.0, 0.5, 0.0, 1]])

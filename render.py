...
draw_circle((100, mid_y), 10, corn_flour_white)
draw_circle((200, mid_y), 20, corn_flour_white)
draw_circle((300, mid_y), 30, corn_flour_white)
draw_circle((500, mid_y), 40, corn_flour_white)
draw_circle((800, mid_y), 50, corn_flour_white)
draw_circle((1300, mid_y), 60, corn_flour_white)
draw_circle((2100, mid_y), 70, corn_flour_white)
